// Package generator renders HTML documentation sites from a parsed SrvDoc.
// The generated HTML is a self-contained, single-file site with sidebar
// navigation, live search, expandable schema panels, and multi-language
...
// GenerateHtml renders a self-contained HTML documentation site from doc,
// writing it to outputPath. outDir and currentVersion are used to populate
// the version selector when versioned docs are being generated.
func GenerateHtml(doc *parser.SrvDoc, title, outputPath string, outDir string, currentVersion string) error {
	...
	schemasMap := make(map[string]parser.StructDef)
