// Package openapi generates OpenAPI 3.0 specifications from a parsed SrvDoc.
package openapi
...
// Generate builds an OpenAPI 3.0 specification from doc, writing pretty-printed
// JSON to outputPath. title is used as the API title in the info block.
func Generate(doc *parser.SrvDoc, title, outputPath string) error {
	spec := Spec{
		OpenAPI: "3.0.3",
	...
	for _, r := range doc.Routes {
		...
		// If input type exists for mutating methods, add a requestBody
